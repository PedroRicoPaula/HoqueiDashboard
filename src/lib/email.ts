...
<body style="font-family:sans-serif;background:#f9fafb;margin:0;padding:32px">
  <div style="max-width:520px;margin:0 auto;background:#fff;border-radius:12px;padding:40px;border:1px solid #e5e7eb">
    ...
    <p style="color:#374151;margin-bottom:24px">O seu email de acesso é <strong>${escHtml(email)}</strong>. Clique no botão abaixo para definir a sua palavra-passe e entrar no dashboard.</p>

    <a href="${escHtml(setPasswordUrl)}" style="display:block;background:#16a34a;color:#fff;text-align:center;padding:14px 24px;border-radius:8px;text-decoration:none;font-weight:600;font-size:15px;margin-bottom:24px">
